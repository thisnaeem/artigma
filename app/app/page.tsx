...
import { PhotoIcon, SparklesIcon, Square3Stack3DIcon, TagIcon, DocumentTextIcon } from "@heroicons/react/24/outline";
...
import OneWordGenerator from './components/OneWordGenerator';
import BulkPromptGenerator from './components/BulkPromptGenerator';
...
export default function Home() {
  ...
  const tabs = [
    ...
    { name: 'One Word', icon: TagIcon },
    { name: 'Bulk Prompt', icon: DocumentTextIcon },
  ];
